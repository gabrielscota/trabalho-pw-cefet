	...
	class ProdutoDAO extends CrudDAO
	{
		...
		public function incluir($produto){	
			...
			try{
				...
				$run = $pdo->prepare($sql);
				$run->bindValue(':nome', $produto->getNome(), PDO::PARAM_STR); 
				$run->bindValue(':descricao', $produto->getDescricao(), PDO::PARAM_STR); 
				$run->bindValue(':valor', $produto->getValor(), PDO::PARAM_INT); 
				$run->bindValue(':quantidade', $produto->getQuantidade(), PDO::PARAM_INT); 
				$run->bindValue(':foto', $produto->getFoto(), PDO::PARAM_STR); 
				$run->bindValue(':idCategoria', $produto->getCategoria()->getIdCategoria(), PDO::PARAM_INT); 
	  			$run->execute(); 

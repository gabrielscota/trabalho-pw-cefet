<?php	
	...
	if(isset($_GET["idPedido"])){
		...
		$listaProduto = $pedidoProdutoDAO->listarPorPedido($pedido->getIdPedido());
		$valorTotal = 0;
			...
			?>
								...
								<?php
									if($pedido->getIdPedido()!=0){
										...
										foreach($lista as $pedidoProduto){						
											...
											echo"<td>{$pedidoProduto->getValorTotal()} </td>";
				...
				<div class="row form-group">
						<div class="col-md-12">
							...
							<input class="form-control" id="valorTotal" name="valorTotal" type="text" value="<?php echo $valorTotal ?>" readonly="true">
						</div>			
				</div>
			<?php 
				if($pedido->getIdPedido()==0){
